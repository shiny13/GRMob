...
class Level2Scene: SKScene {
    ...
    func generateBackground()
    {
        ...
        let background = SKSpriteNode(imageNamed: "MapEnvir4-12.png")
    ...
    func drawLabelSprite(quesSet: QuestionSet)
    {
        ...
        answer1.position = CGPointMake(self.size.width * 0.45, self.size.height * 0.81)
        ...
        answer2.position = CGPointMake(self.size.width * 0.45, self.size.height * 0.72)
        ...
        answer3.position = CGPointMake(self.size.width * 0.45, self.size.height * 0.63)
        ...
        answer4.position = CGPointMake(self.size.width * 0.45, self.size.height * 0.54)
    ...
    {
        self.check1.position = CGPointMake(self.size.width * 0.25, self.size.height * 0.82)
        self.check1.setScale(0.15)
        self.check1.name = "check1"
        self.addChild(self.check1)
        
        self.check2.position = CGPointMake(self.size.width * 0.25, self.size.height * 0.73)
        self.check2.setScale(0.15)
        self.check2.name = "check2"
        self.addChild(self.check2)
        
        self.check3.position = CGPointMake(self.size.width * 0.25, self.size.height * 0.64)
        self.check3.setScale(0.15)
        self.check3.name = "check3"
        self.addChild(self.check3)
        
        self.check4.position = CGPointMake(self.size.width * 0.25, self.size.height * 0.55)
    ...
    {
        let bins = level2Bins()
        bins.spawn(world, canvasSize: self.size)
        let tree = Level2Tree()
        tree.spawn(world, canvasSize: self.size)
        let grass = Level2Grass()
        grass.spawn(world, canvasSize: self.size)
        let rainbow = Level2Rainbow()
        rainbow.spawn(world, canvasSize: self.size)
        
        spriteEffects = [bins, tree, grass, rainbow]
    }
    ...
    func correctAnswerEffect()
    {
        switch counter
        {
        case 0: let bins:level2Bins = spriteEffects[counter] as! level2Bins
                bins.playCreateAnimation(self.size)
                break;
        case 1: let tree:Level2Tree = spriteEffects[counter] as! Level2Tree
                tree.playCreateAnimation(self.size)
                break;
        case 2: let grass:Level2Grass = spriteEffects[counter] as! Level2Grass
                grass.playCreateAnimation(self.size)
                break;
        case 3: let rainbow:Level2Rainbow = spriteEffects[counter] as! Level2Rainbow
                rainbow.playCreateAnimation(self.size)
                break;
        default: break
        }
    }
    ...
    func playVideo()
    {
        ...
        if let urlStr = NSBundle.mainBundle().pathForResource("Animation2", ofType: "mp4")
        {
            ...
            let wait = SKAction.waitForDuration(23)
    ...
    func endSceneWithEffect()
    {
        ...
        let wait2 = SKAction.waitForDuration(23)

...
class Level4Grass: SKSpriteNode, EffectSprite {
    ...
    {
        let moveGrass1 = SKAction.moveTo(CGPoint(x: -220, y: canvasSize.height * 0.17), duration: 2)
        let moveGrass2 = SKAction.moveTo(CGPoint(x: -30, y: canvasSize.height * 0.17), duration: 2)
        let moveGrass3 = SKAction.moveTo(CGPoint(x: 150, y: canvasSize.height * 0.17), duration: 2)
        let moveGrass4 = SKAction.moveTo(CGPoint(x: 400, y: canvasSize.height * 0.17), duration: 2)

...
class Level3Fish2: SKSpriteNode, EffectSprite {
    
    var fish1 = SKSpriteNode(imageNamed: "fish-02.png")
    var fish2 = SKSpriteNode(imageNamed: "fish-02.png")
    var fish3 = SKSpriteNode(imageNamed: "fish-02.png")
    ...
    func spawn(parentNode: SKNode, canvasSize: CGSize)
    {
        ...
        fish1.position = CGPointMake(canvasSize.width * -1, -1000)
        fish1.setScale(0.2)
        fish1.zPosition = -15
        self.addChild(fish1)
        
        fish2.position = CGPointMake(canvasSize.width * -1, -1000)
        fish2.setScale(0.3)
        fish2.zPosition = -15
        self.addChild(fish2)
        
        fish3.position = CGPointMake(canvasSize.width * -1, -1000)
        fish3.setScale(0.24)
        fish3.zPosition = -15
        self.addChild(fish3)
    ...
    {
        let moveFish1 = SKAction.moveTo(CGPoint(x: 450, y: canvasSize.height * 0.45), duration: 2)
        let moveFish2 = SKAction.moveTo(CGPoint(x: 550, y: canvasSize.height * 0.34), duration: 2)
        let moveFish3 = SKAction.moveTo(CGPoint(x: 400, y: canvasSize.height * 0.4), duration: 2)
